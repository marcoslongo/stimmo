...
export type CategoriaPortfolio = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  ...
  /** Ícone da categoria do portfólio */
...
/** The &quot;ConeDaCategoria&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type ConeDaCategoria = AcfFieldGroup & AcfFieldGroupFields & ConeDaCategoria_Fields & {
  __typename?: 'ConeDaCategoria';
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;image&quot; Field Type added to the schema as part of the &quot;ConeDaCategoria&quot; Field Group */
  icone?: Maybe<AcfMediaItemConnectionEdge>;
};

/** Interface representing fields of the ACF &quot;ConeDaCategoria&quot; Field Group */
export type ConeDaCategoria_Fields = {
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
